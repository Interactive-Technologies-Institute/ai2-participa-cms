...
const translations = {
  pt: {
    ...
    // Site
    "site.description": "Espaço de diálogo sobre a Avaliação Estratégica para a definição das prioridades nacionais de investigação e inovação no âmbito da criação da AI².",
    // Header
    ...
    // Footer
    "footer.description": "Espaço de diálogo sobre a Avaliação Estratégica para a definição das prioridades nacionais de investigação e inovação no âmbito da criação da AI².",
    ...
    "footer.copyright": "© 2026 PLANAPP. Processo promovido pelo Ministério da Educação, Ciência e Inovação. Todos os direitos reservados.",
    "footer.backToTop": "Voltar ao topo ↑",
    // Home
    "home.imgAlt": "AI² - Agência para a Investigação e Inovação",
    "home.heading": "Espaço de diálogo sobre as prioridades nacionais de investigação e inovação no âmbito da criação da AI²",
    "home.participateBtn": "Participe no Diálogo",
    "home.ctaText": "A sua participação é essencial para definir o futuro da investigação e da inovação em Portugal. Participe no espaço de diálogo e contribua para o desenvolvimento científico e tecnológico do país.",
  ...
  en: {
    ...
    // Site
    "site.description": "Dialogue space on the Strategic Assessment for defining national research and innovation priorities in the context of creating AI².",
    // Header
    ...
    // Footer
    "footer.description": "Dialogue space on the Strategic Assessment for defining national research and innovation priorities in the context of creating AI².",
    ...
    "footer.copyright": "© 2026 PLANAPP. Process promoted by the Ministry of Education, Science and Innovation. All rights reserved.",
    "footer.backToTop": "Back to top ↑",
    // Home
    "home.imgAlt": "AI² - Agency for Research and Innovation",
    "home.heading": "Dialogue space on the national research and innovation priorities in the context of creating AI²",
    "home.participateBtn": "Participate in the Dialogue",
    "home.ctaText": "Your participation is essential to define the future of research and innovation in Portugal. Participate in the dialogue space and contribute to the country's scientific and technological development.",
